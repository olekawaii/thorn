...
instance Show ErrorType where 
  show err = case err of
    Help ->
      ...
      <> "  \x1b[33m-d\x1b[0m \x1b[36mDIR\x1b[0m    Directory in which to save the output\n"
      ...
      <> "  \x1b[33m-n\x1b[0m \x1b[35mNAME\x1b[0m   which function to evaluate\n"
      <> "  \x1b[33m-q\x1b[0m        Suppress success animation\n"
      <> "  \x1b[33m-t\x1b[0m a      Where a is either `vid` or `loop`"
    ...
    NoMatchingName a suggestion -> format "Could not find the function `%` in the input files%"
